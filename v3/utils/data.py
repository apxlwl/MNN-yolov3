...
class Data(object):
    def __init__(self):
        ...
        annotations_2007 = self.__load_annotations(os.path.join(self.__dataset_path, 'VOC2007'))
        annotations_2012 = self.__load_annotations(os.path.join(self.__dataset_path, 'VOC2012'))
