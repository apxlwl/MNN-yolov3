...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', help='select a gpu for test', default='1', type=str)
    ...
    args.test_weight = 'yolo.ckpt-60-0.7911'
    ...
    if args.t07:
        ...
        # test_set_path = os.path.join(cfg.DATASET_PATH, 'VOC%d' % 2007)
        # img_inds_file = os.path.join(test_set_path, 'ImageSets','test.txt')
        # with open(img_inds_file, 'r') as f:
        #     txt = f.readlines()
        #     image_inds = [line.strip() for line in txt]
        # image_ind = np.random.choice(image_inds)
        # image_path = os.path.join(test_set_path, 'JPEGImages', image_ind + '.jpg')
        image_path='/home/gwl/datasets/VOCdevkit/VOC2007/JPEGImages/004650.jpg'
